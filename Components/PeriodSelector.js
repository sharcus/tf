...
export const PeriodSelector = (props) => {
    ...
    return <View style={styles.navigationPanel}>
        <FeederButton style={styles.naviagationButton} Text="<" onPress={handleBackClicked} />
        <Text style={styles.navigationLabel}>{periodLabel}</Text>
        <FeederButton style={styles.naviagationButton} Text=">" onPress={handleForwardClicked} />
    </View>
}
